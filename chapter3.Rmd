...
1. Construire une matrice avec 3 lignes contenant les numéros 1 jusqu'à 9 dans l'éditeur, Cliquer sur le bouton **Submit Answer** et regarder la sortie dans la console. Astuce, utilisez: `matrix(1:9, byrow = FALSE, nrow = 3)`.
...
test_object("mat <- matrix(1:9, byrow=FALSE, nrow=3)", undefined_msg = msg, incorrect_msg = msg)
