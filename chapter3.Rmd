...
test_object("matrix(1:9, byrow=TRUE, nrow=3)", undefined_msg = msg, incorrect_msg = msg)
...
non.us.all  <-     #Votre code ici
non.us.some <-     #Votre code ici
...
# Selectionner le revenue pour "A New Hope"
...
# Sélectionnez les deux dernières lignes et les deux colonnes
